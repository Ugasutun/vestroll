...
export class PasswordResetService {
   ...
   * Invalidates any existing tokens for the user first.
   * Always returns without error even if the email is not found (prevents user enumeration).
   */
  ...
  /**
   * Validates the reset token, updates the user's password hash, and deletes the used token.
   */
